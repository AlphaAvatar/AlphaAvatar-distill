...
`(FC-FP) - (DC-DP)` (`logs/stages/stage-3/e8b/plans/e8b_preregistration.md` §8) — negative means the map does
...
def main() -> int:
    ...
    ap.add_argument("--level", choices=("step0", "behaviour", "both"),
                    default="step0")
    ap.add_argument("--records", default="logs/stages/stage-3/e8b/history/e8b_step0_records")
