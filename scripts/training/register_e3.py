...
"""Write the immutable Experiment 3 registration, BEFORE anything trains.
    ...
    PYTHONPATH=src python scripts/training/register_e3.py --out logs/experiments/early/analyses/e3_registration.json
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "logs/experiments/early/analyses/e3_registration.json")
    args = ap.parse_args()
