...
"""Write the immutable Experiment 4 registration, BEFORE anything trains.
    ...
    PYTHONPATH=src python scripts/training/register_e3.py --out logs/stages/stage-3/e4/analyses/e4_registration.json
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "logs/stages/stage-3/e4/analyses/e4_registration.json")
    args = ap.parse_args()
