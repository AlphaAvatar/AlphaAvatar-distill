...
"""Write the immutable Experiment 4 registration, BEFORE anything trains.
    ...
    PYTHONPATH=src python scripts/training/register_e3.py --out logs/cross-stage/early/analyses/e4_registration.json
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "logs/cross-stage/early/analyses/e4_registration.json")
    args = ap.parse_args()
