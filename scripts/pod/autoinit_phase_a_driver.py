...
STAGE3_THRESHOLDS = REPO / "logs/experiments/phase_a/results/autoinit_stage3_complete/materialized_thresholds.json"
STAGE3_EVALUATION_PROTOCOL_HASH = (
    "250f72efbd43b86a475e8dda293b45f07ee61a4d858e147f4a5bd7681c32c2e4")
STAGE3_ATTESTATION = REPO / "logs/experiments/phase_a/results/autoinit_stage3_complete/attested_evaluation_protocol.json"
...
#: `logs/experiments/recovery_continuation/analyses/autoinit_recovery_trainer_memory_basis.json` and a test pins these terms
#: against it.
#:
...
COMPAT_V2 = REPO / "logs/experiments/phase_a/analyses/autoinit_phase_a_protocol_compat_v2.json"
...
class PhaseADriver:
    ...
    AUTHORIZATION_PATH = "logs/budget/approvals/autoinit_phase_a_authorization.json"
    ...
    def emit_leaf_retention(self, records: list[dict]) -> dict:
        ...
        here in the shape `logs/maintenance/inventories/checkpoint_tombstones.json` already uses. The
