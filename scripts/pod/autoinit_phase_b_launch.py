...
counterfactual**, priced in `logs/stages/stage-1/phase_b/analyses/autoinit_phase_b_pricing.json` only so the
...
PREREGISTRATION = REPO_ROOT / "logs/stages/stage-1/phase_b/plans/autoinit_phase_b_preregistration.json"
