...
counterfactual**, priced in `logs/cross-stage/phase_b/analyses/autoinit_phase_b_pricing.json` only so the
...
PREREGISTRATION = REPO_ROOT / "logs/cross-stage/phase_b/plans/autoinit_phase_b_preregistration.json"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap = phase_a_parser()
    ap.set_defaults(out="logs/cross-stage/phase_b/analyses/autoinit_phase_b_session.json",
