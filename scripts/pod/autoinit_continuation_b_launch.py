...
PREREGISTRATION = REPO_ROOT / "logs/cross-stage/continuation_b/plans/autoinit_continuation_b_preregistration.json"
...
CONTINUATION_ASSET_MANIFEST = REPO_ROOT / "logs/cross-stage/continuation_b/analyses/autoinit_continuation_b_assets.json"
...
# `logs/cross-stage/continuation_b/analyses/autoinit_continuation_b_capacity.json`.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap = phase_a_parser()
    ap.set_defaults(out="logs/cross-stage/continuation_b/analyses/autoinit_continuation_b_session.json",
                    disk_gb=120,
