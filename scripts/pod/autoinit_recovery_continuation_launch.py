...
#: it -- see logs/shared/analyses/autoinit_selected_leaf_transport_manifest.json.
TRANSPORT_REPO = "AlphaAvatar/aadistill-transport"
TRANSPORT_MANIFEST = REPO_ROOT / "logs/shared/analyses/autoinit_selected_leaf_transport_manifest.json"
