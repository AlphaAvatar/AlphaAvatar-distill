...
#
# Attempt 6 runs under $5.71, what survived attempts 1-5. 346 min x $0.99 =
# $5.71, so the RunPod-side deadline cannot on its own exceed
...
BACKSTOP_MINUTES=${BACKSTOP_MINUTES:-346}
...
POLL_LIMIT_MIN=${POLL_LIMIT_MIN:-336}   # inside the 346-min backstop
