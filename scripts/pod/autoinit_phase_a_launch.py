...
`logs/cross-stage/phase_a/analyses/autoinit_phase_a_storage.md`.
...
#: is 8,866.1 s. Derived in `logs/cross-stage/phase_a/analyses/autoinit_phase_a_fallback_audit.json`.
#:
        ...
        evidence_fields={
            ...
            "priced_probes": {
                ...
                "why_this_exceeds_the_repricing_doc": (
                    "logs/cross-stage/phase_a/analyses/autoinit_phase_a_repricing.md priced search + probes "
...
def build_parser() -> argparse.ArgumentParser:
    ...
    #: decision, not a launcher's. See logs/cross-stage/phase_a/analyses/autoinit_phase_a_storage.md.
    ...
    ap.add_argument("--out", default="logs/cross-stage/phase_a/analyses/autoinit_phase_a_session.json")
    return ap
