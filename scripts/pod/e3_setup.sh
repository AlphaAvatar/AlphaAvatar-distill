...
say "Experiment 3 arm validation on the real student"
cd "$REPO" && PYTHONPATH=src /opt/train/bin/python scripts/training/validate_e3_arms.py \
    --out artifacts/audit/e3_prelaunch_validation_pod.json
mark ARMS_VALIDATED
mark TESTS_OK
