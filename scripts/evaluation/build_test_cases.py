...
Writes two files:
  ...
  * a JSONL file with the same cases, for programmatic analysis
    ...
    uv run python scripts/evaluation/build_test_cases.py \
        --eval-dir artifacts/eval/e1 --out logs/cross-stage/early/analyses/e1_test_cases.md
"""
...
def main() -> None:
    ...
    ap.add_argument("--out", default="logs/cross-stage/early/analyses/e1_test_cases.md")
