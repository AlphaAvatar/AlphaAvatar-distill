...
The interpretation is fixed in advance (`logs/cross-stage/early/analyses/e7_preregistration.md` 7.4) and
...
REGISTRATION = REPO_ROOT / "logs/cross-stage/early/analyses/e7_preregistration.md"
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "logs/cross-stage/early/analyses/e7_results.json")
    ap.add_argument("--report", type=Path, default=REPO_ROOT / "logs/cross-stage/early/analyses/e7_report.md")
