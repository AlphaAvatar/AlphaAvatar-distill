...
The interpretation is fixed in advance (`logs/stages/stage-3/e7/analyses/e7_preregistration.md` 7.4) and
...
REGISTRATION = REPO_ROOT / "logs/stages/stage-3/e7/analyses/e7_preregistration.md"
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "logs/stages/stage-3/e7/analyses/e7_results.json")
    ap.add_argument("--report", type=Path, default=REPO_ROOT / "logs/stages/stage-3/e7/analyses/e7_report.md")
