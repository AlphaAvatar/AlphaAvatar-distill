...
"""Experiment 6 analysis: the E1 PCA scale curve on the frozen 150-prompt battery.
    ...
    PYTHONPATH=src python scripts/evaluation/analyze_e6.py \
        --out artifacts/audit/e6_results.json --report logs/experiments/early/analyses/e6_report.md
...
REGISTRATION = REPO_ROOT / "logs/experiments/early/analyses/e6_registration.json"
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "logs/experiments/early/analyses/e6_results.json")
    ap.add_argument("--report", type=Path, default=REPO_ROOT / "logs/experiments/early/analyses/e6_report.md")
