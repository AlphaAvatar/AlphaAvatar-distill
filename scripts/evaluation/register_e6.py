...
"""Write the immutable Experiment 6 registration, BEFORE any GPU is created.
    ...
    PYTHONPATH=src python scripts/evaluation/register_e6.py --out logs/experiments/early/analyses/e6_registration.json
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "logs/experiments/early/analyses/e6_registration.json")
