...
REGISTRATION = REPO_ROOT / "logs/stages/stage-3/e6b/analyses/e6b_registration.json"
...
def main() -> None:
    ...
    ap.add_argument("--out", type=Path, default=REPO_ROOT / "logs/stages/stage-3/e6b/analyses/e6b_results.json")
    ap.add_argument("--report", type=Path, default=REPO_ROOT / "logs/stages/stage-3/e6b/analyses/e6b_report.md")
