...
PHASE_B_EXECUTABLE_SOURCE_FILES_V1: tuple[str, ...] = (
    ...
    "src/aadistill/initialization/specs/arch.py",
    "src/aadistill/initialization/specs/artifact.py",
    ...
    "scripts/experiments/phase_b/plan.py",
    ...
    "src/aadistill/initialization/statistics/spec.py",
...
#: historical-reuse verifier did (3), the Phase-B pricing module did (4), the
#: Stage-1 selection artifact did (5), and identity collapse did (6) — it decides
#: which candidates are distinct, which is the behavioural universe itself — it is written inside the paid search and
