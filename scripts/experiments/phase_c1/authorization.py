...
`c1_budget_spec()` reads `logs/stages/stage-1/phase_c1/plans/phase_c1_pricing.json` and builds the `BudgetSpec`
...
PRICING_PATH = "logs/stages/stage-1/phase_c1/plans/phase_c1_pricing.json"
