...
PROBES = REPO_ROOT / "logs/stages/stage-1/continuation_b/runs/attempt4/probes"
WITHDRAWN = REPO_ROOT / "logs/stages/stage-1/continuation_b/runs/attempt4/phase_a_result.json"
...
def recompute() -> dict:
    ...
    return {
        ...
        "source_probes": "logs/stages/stage-1/continuation_b/runs/attempt4/probes",
        ...
        "sc_still_owed": owed,
        "withdrawn_decision": {
            "source": "logs/stages/stage-1/continuation_b/runs/attempt4/phase_a_result.json",
...
def main() -> None:
    ...
    ap.add_argument("--out",
                    default="logs/stages/stage-1/continuation_b/analyses/autoinit_continuation_b_corrected_rung2.json")
    args = ap.parse_args()
    out = Path(args.out)
