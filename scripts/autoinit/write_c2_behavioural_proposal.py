        ...
        "campaign": {
            ...
            "handoff": {
                ...
                "cost": (
                    ...
                    "campaign has left. RESOLVED 2026-09-23: the probes are "
                    "pre-staged onto a provider network VOLUME, written once "
                    "through a $0.06/h CPU pod with every file re-hashed from "
                    "the bytes that landed, and each later pod ATTACHES it. "
                    "There is no session-time transfer at all; what remains on "
                    "the meter is re-reading and re-identifying them, reserved "
                    "at 45 minutes. The uplink is a HOST cap rather than a "
