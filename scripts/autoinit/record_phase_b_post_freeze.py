...
Regenerates `logs/cross-stage/phase_b/analyses/autoinit_phase_b_post_freeze_changes.json` from the tree as it
...
PREREG = REPO_ROOT / "logs/cross-stage/phase_b/plans/autoinit_phase_b_preregistration.json"
...
def main() -> None:
    ...
    note = REPO_ROOT / "logs/cross-stage/phase_b/analyses/autoinit_phase_b_post_freeze_changes.json"
    if note.is_file():
        raise SystemExit(
            "refusing: logs/cross-stage/phase_b/analyses/autoinit_phase_b_post_freeze_changes.json is the "
    ...
    ap.add_argument("--out", default="logs/cross-stage/phase_b/analyses/autoinit_phase_b_post_freeze_changes.json")
    args = ap.parse_args()
