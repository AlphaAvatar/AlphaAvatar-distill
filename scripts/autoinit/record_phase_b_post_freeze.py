...
PREREG = REPO_ROOT / "logs/stages/stage-1/phase_b/plans/autoinit_phase_b_preregistration.json"
...
def main() -> None:
    ...
    note = REPO_ROOT / "logs/stages/stage-1/phase_b/analyses/autoinit_phase_b_post_freeze_changes.json"
    if note.is_file():
        raise SystemExit(
            "refusing: logs/stages/stage-1/phase_b/analyses/autoinit_phase_b_post_freeze_changes.json is the "
