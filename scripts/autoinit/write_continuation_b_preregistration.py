...
ASSETS = REPO_ROOT / "logs/stages/stage-1/continuation_b/analyses/autoinit_continuation_b_assets.json"
SELECTION = REPO_ROOT / "logs/stages/stage-1/phase_b/runs/attempt5/stage1_selection.json"
...
FROZEN = REPO_ROOT / "logs/stages/stage-1/phase_a/analyses/autoinit_phase_a_recovery_plan_frozen.json"
...
def build() -> dict:
    ...
    body = {
        ...
        "science_plan": {"plan_hash": science,
                         "source": "logs/stages/stage-1/phase_a/analyses/autoinit_phase_a_recovery_plan_frozen.json",
                         "unchanged": True},
        "session_plan": {
...
def main() -> None:
    ...
    ap.add_argument("--out", default="logs/stages/stage-1/continuation_b/plans/autoinit_continuation_b_preregistration.json")
    args = ap.parse_args()
    body = build()
    out = Path(args.out)
