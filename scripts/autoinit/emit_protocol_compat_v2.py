...
`logs/stages/stage-1/phase_a/results/autoinit_stage3_complete/{attested_evaluation_protocol,materialized_thresholds}.json`
...
def main() -> int:
    ...
    ap.add_argument("--out", default="logs/stages/stage-1/phase_a/analyses/autoinit_phase_a_protocol_compat_v2.json")
    args = ap.parse_args()
