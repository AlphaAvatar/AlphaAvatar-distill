...
def test_changing_the_chunk_count_does_perturb_the_last_bits():
    ...
    the re-pricing note in logs/stages/stage-3/e8b/analyses/e8b_reprice_after_gate.json needs rewording.
    """
    s, t, mask = _inputs(0, vocab=1024)
...
def test_the_default_chunk_is_the_value_the_gate_ran_with():
    ...
    # logs/stages/stage-3/e8b/analyses/e8b_reprice_after_gate.json no longer describes what runs.
    import inspect
