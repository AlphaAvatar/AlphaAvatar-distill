...
def test_the_executing_plan_reproduces_the_frozen_one():
    ...
    frozen = REPO / "logs/experiments/phase_a/analyses/autoinit_phase_a_recovery_plan_frozen.json"
...
def test_the_two_soft_stop_reserves_are_named_and_carry_their_derived_minutes():
    ...
    audit = json.loads((REPO / "logs/experiments/phase_a/analyses/autoinit_phase_a_fallback_audit.json").read_text())
    ...
    sweep = json.loads((REPO / "logs/experiments/shared/analyses/autoinit_v1_search_space.json").read_text())["sweep"]
...
def test_the_deadline_derivation_moves_no_frozen_identity():
    ...
    assert json.loads((REPO / "logs/experiments/phase_a/analyses/autoinit_phase_a_recovery_plan_frozen.json")
