...
CLEAN_STAGES: dict = {
    ...
    "bf16_controls": {
        ...
        "split_k_state": {"default": True,
                          ...
                          "cublaslt_defaults": True,
                          "reduced_precision_off_splitk_off": False},
        "blas_library": {"default": "cublas",
                         "reduced_precision_off_splitk_on": "cublas",
                         "cublaslt_defaults": "cublaslt",
                         "reduced_precision_off_splitk_off": "cublaslt"},
        "improvement_attributable_to": "the_split_k_flag",
        "backend_switch_alone_fixes_it": False,
        "projections_still_shape_dependent": {
            "default": ["k", "v", "attn_out", "ffn_out"],
            "reduced_precision_off_splitk_on": ["k", "v"],
            "cublaslt_defaults": ["k", "v"],
