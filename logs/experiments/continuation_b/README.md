...
Experiment-level material for `continuation_b`. Its **runs** are elsewhere —
this directory holds what belongs to the experiment as a whole.

## Its runs, from the index

* `attempt1` — `logs/autoinit_continuation_b_attempt1`
* `attempt2` — `logs/autoinit_continuation_b_attempt2`
* `attempt3` — `logs/autoinit_continuation_b_attempt3`
* `attempt4` — `logs/autoinit_continuation_b_attempt4`
* `attempt5` — `logs/autoinit_continuation_b_attempt5`
