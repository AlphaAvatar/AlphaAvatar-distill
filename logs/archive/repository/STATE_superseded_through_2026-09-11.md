# Superseded repository state, through 2026-09-11

Everything below was the `logs/STATE.md` "current state" of an earlier
moment and is kept verbatim. **Moved here on 2026-09-12**, unedited.

It spans several experiments — Phase A, Phase B, the continuations and early
Phase C1 — which is why it is archived as one document rather than split
between them: the sections cross-reference each other and splitting would
break the narrative that makes them readable.

It describes states that are no longer true. Read it as evidence of what was
believed when it was written, never as current. Nothing here authorizes
anything.
...
battery size is
[`phase_c0_sizing_evidence.json`](../experiments/phase_c1/phase_c0_sizing_evidence.json).
...
| the power evidence behind N=850 | [`phase_c0_sizing_evidence.json`](../experiments/phase_c1/phase_c0_sizing_evidence.json) |
...
| storage and what was cleaned | [`storage_closeout_20260831.json`](../maintenance/storage_closeout_20260831.json) |
...
([`phase_a_vs_phase_b_comparison.md`](../experiments/phase_a/phase_a_vs_phase_b_comparison.md)) is
...
Records: [`scratch_inventory_20260829.json`](../maintenance/scratch_inventory_20260829.json) and
...
1b. **The behavioural continuation** — the only paid work Phase B still owes,
   ...
   **A static completeness gate now prevents the class**
   ...
   Detail: [`autoinit_phase_b_reconstruction.md`](../experiments/phase_b/autoinit_phase_b_reconstruction.md),
