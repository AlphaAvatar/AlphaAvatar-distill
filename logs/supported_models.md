...
| --- | --- | --- | --- | --- | --- | --- |
| qwen3-4b-thinking-distill (working name) | Qwen/Qwen3-4B-Thinking-2507 @ `768f209d` | 0.6B-class (hidden 1024, 28L, FFN 3072, 16Q/8KV, tied emb; user-chosen 2026-07-13) | stage1-passed | Stage 0, Stage 1 | `artifacts/stage1/qwen3_0p6b_init_v0/checkpoint` (local, gitignored; 596.0M params) | Stage 0 v1: 949,859 tokens ([log](experiments/2026-07-13_stage0_qwen3_4b_thinking_v1.md)). Stage 1 init gate passed; holdout NLL 11.75 vs random 12.13 vs teacher 2.63 — pre-recovery init, width is the bottleneck ([log](experiments/2026-07-14_stage1_qwen3_0p6b_init_v0.md)). Deployment target: INT8. Next: Stage 2. |
