...
| **Phase C1** | **IMPLEMENTED / PRICED / NOT EXECUTED / NOT AUTHORIZED** | fixed-path ATTENTION isolation using short 0.86M recovery probes. Runnable session, battery and price all exist ($13.7578 ceiling); no grant, no probe, no arm evaluated. Structure in [`phase_c_roadmap.md`](phase_c_roadmap.md) |
