...
[experiment record](../archive/indexes/EXPERIMENTS.md); per-run logs were merged into it on
...
([decision](../budget/decisions.md), [record](../archive/indexes/EXPERIMENTS.md) §12.15).
...
only ([`decisions.md`](../budget/decisions.md) 2026-08-05, [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §19).
...
tag in the transfer path ([EXPERIMENTS.md](../archive/indexes/EXPERIMENTS.md) §27), so re-evaluating
...
the storage risk in [`STATE.md`](current.md).
