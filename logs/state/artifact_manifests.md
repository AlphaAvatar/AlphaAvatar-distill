...
* **Per-run experiment logs were consolidated** into
  [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) on 2026-07-31 (`1fbcb99`); the originals are
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §11,
...
- **Storage: on the relay under `stage3_recovery_corpus_v2/`** (9/9 files
  hash-verified 2026-08-01, [`STATE.md`](current.md) §2) **and** on the dev box at
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §10, [`STATE.md`](current.md)
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §5, §6.
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §5.
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §3 (start-point ablation).
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §2 (Stage 1);
  purpose: transfer vehicle for the `from_init` arm of the start-point ablation
  (consolidated into [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §3). It was the only
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §3 (mixture v1).
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §3 (s1 FFN+norm);
...
- **Related logs:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §3 (sub-stage 2 A/B).
...
- **Experiment log:** [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §4 (engine benchmark)
...
- **Related logs:** [`PROPOSAL.md`](../archive/PROPOSAL.md) §3–§4,
  [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §12.
...
- **Related logs:** [`PROPOSAL.md`](../archive/PROPOSAL.md) §2,
  [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §12.2.
...
- **Related logs:** [`PROPOSAL.md`](../archive/PROPOSAL.md) §6–§7,
  [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §12.7–§12.8.
...
Full detail in [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §19.14. Digests:
...
`sha256_json` of the parsed config, matching `logs/experiments/early/analyses/e3_registration.json`.
...
`logs/experiments/early/analyses/e4_registration.json`. Both fork from the Stage 1 init `86fbba78…`; neither
...
- **What survives, and it is everything except the weights:** all four evaluation
  ...
  [`logs/experiments/early/analyses/e3_registration.json`](../experiments/early/analyses/e3_registration.json), and the full record at
  [`EXPERIMENTS.md`](../archive/indexes/EXPERIMENTS.md) §20. **The experiment remains fully
...
| summary + report | `logs/experiments/early/analyses/e6b_results.json`, `logs/experiments/early/analyses/e6b_report.md` | tracked; reproduce byte-identically from the generations |
...
[`e6b_protocol_deviations.md`](../experiments/early/analyses/e6b_protocol_deviations.md).
...
**Derived artifact:** `logs/experiments/early/analyses/e6b_reconstructed_training_events.json`
...
Rebuild commands: [`e7_preregistration.md`](../experiments/early/analyses/e7_preregistration.md) §11.
...
- **Local copy:** was `/home/ecs-user/aad-artifacts/wheelhouse_vllm_cp312`
  ...
  recorded in [`relay_mirror_verification.json`](../validations/relay-mirror/relay_mirror_verification.json).
  Pods fetch from the relay, never from the dev box, whose uplink is 0.72 MB/s.
- **Related:** `logs/budget/decisions.md` 2026-08-18 (cleanup);
...
- **Known gap:** per-sample rows for `fe9683e6a9c7/sb` do not exist anywhere;
  ...
  aggregate counts.
- **Related:** `logs/budget/decisions.md` 2026-09-01; `logs/state/current.json`
  (`storage.preserved_scratch_20260901`); `logs/state/current.md`;
  `logs/experiments/phase_c1/plans/phase_c0_sizing_evidence.json`.
...
- **Committed identity:** [`phase_c1_battery.json`](../experiments/phase_c1/plans/battery.json) —
