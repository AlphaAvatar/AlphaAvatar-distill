...
- **Local copy:** was `/home/ecs-user/aad-artifacts/wheelhouse_vllm_cp312`
  ...
  recorded in [`relay_mirror_verification.json`](../shared/validations/relay-mirror/relay_mirror_verification.json).
...
- **Related:** `logs/budget/decisions.md` 2026-09-01; `logs/state/current.json`
  ...
  `logs/stages/stage-1/phase_c1/plans/phase_c0_sizing_evidence.json`.
...
- **Committed identity:** [`phase_c1_battery.json`](../stages/stage-1/phase_c1/plans/battery.json) —
