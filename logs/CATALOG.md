...
| `autoinit_c1_attempt1/` | preserved raw evidence for C1 attempt 1: the launcher log with the full setup traceback, the watchdog journal showing the pod billing then gone, and the pod id. 24 KB |
