...
[`../autoinit_preflight_run4/`](../../../../../shared/validations/micro-preflight/runs/autoinit_preflight_run4/).

The controls' weights live in the out-of-tree store and on the relay under
`permanent_controls/`; both are inventoried in
[`../checkpoint_registry.json`](../../../../../maintenance/inventories/checkpoint_registry.json) and are protected
...
| --- | --- | --- |
| `session_evidence.json` | `b39bc39e5908…` (full hash in [`../log_inventory.json`](../../../../../maintenance/inventories/log_inventory.json)) | [`../autoinit_preflight_run4/preflight_evidence.json`](../../../../../shared/validations/micro-preflight/runs/autoinit_preflight_run4/preflight_evidence.json) |
