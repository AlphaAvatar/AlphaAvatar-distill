...
One run of `c2_full_search_cuda`, at `logs/stages/stage-1/c2_full_search_cuda/runs/c2_full_search_cuda_20260917_a2/`.
...
This run executed at `logs/stages/stage-shared/c2_full_search_cuda/runs/c2_full_search_cuda_20260917_a2/` and was retained here when the validation's runs moved into the stage its governance lives in. The old address resolves through `logs/index.json :: historical_paths`; nothing measured changed.
