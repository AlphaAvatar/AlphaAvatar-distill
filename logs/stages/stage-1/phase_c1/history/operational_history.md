...
It is history. For what is true **now** read [`../../STATE.md`](../../../../state/current.md)
and [`../../current_state.json`](../../../../state/current.json); for money read
[`../../BUDGET_LEDGER.md`](../../../../budget/ledger.md); for the runs themselves
read [`../../runs/index.json`](../../../../index.json).
...
| per-attempt hard ceiling | **`$15.1475`** — unchanged, derived from [`phase_c1_pricing.json`](../plans/phase_c1_pricing.json) at secure L40S `$1.09/h`. It already contains a 10% contingency and a 20-minute artifact-recovery reserve; nothing re-buys them |
...
>
> **[`autoinit_c1_attempt9_grant.json`](../../../../budget/approvals/autoinit_c1_attempt9_grant.json) is a
...
> A NEW one-use grant ([`autoinit_c1_attempt8_grant.json`](../../../../budget/approvals/autoinit_c1_attempt8_grant.json)).
...
> A NEW one-use grant ([`autoinit_c1_attempt7_grant.json`](../../../../budget/approvals/autoinit_c1_attempt7_grant.json)).
...
> A NEW one-use grant ([`autoinit_c1_attempt6_grant.json`](../../../../budget/approvals/autoinit_c1_attempt6_grant.json)).
...
>    [`c1_skip_predicate_audit.json`](../analyses/skip_predicate_audit.json) walks all
...
> [`autoinit_c1_attempt5/test_gate_failures.json`](../runs/attempt5/test_gate_failures.json).
