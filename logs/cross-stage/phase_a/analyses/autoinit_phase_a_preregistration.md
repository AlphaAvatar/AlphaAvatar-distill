...
companion: [`autoinit_phase_a_preregistration.json`](../plans/autoinit_phase_a_preregistration.json),
...
([`autoinit_tool_scoring_audit.json`](../../../shared/analyses/autoinit_tool_scoring_audit.json)) ran the
...
Derived in [`autoinit_threshold_characterization.json`](../../../shared/analyses/autoinit_threshold_characterization.json).
...
[`autoinit_role_isolation.json`](../../../shared/analyses/autoinit_role_isolation.json): **passed, complete,
...
([`autoinit_recovery_fingerprint_audit.json`](../../recovery_continuation/analyses/autoinit_recovery_fingerprint_audit.json))
...
[`autoinit_micro_preflight_plan.md`](../../../shared/validations/micro-preflight/autoinit_micro_preflight_plan.md).
