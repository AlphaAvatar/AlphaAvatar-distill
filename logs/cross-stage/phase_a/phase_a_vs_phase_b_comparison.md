...
**Final metrics** ([`autoinit_recovery_continuation_attempt7/phase_a_result.json`](../recovery_continuation/runs/attempt7/phase_a_result.json)):
...
([`autoinit_phase_b_attempt5/stage1_selection.json`](../phase_b/runs/attempt5/stage1_selection.json)):
...
> [`phase_c0_preregistration.json`](../../stages/stage-1/phase_c1/plans/phase_c0_preregistration.json).
>
...
| fact | artifact |
| --- | --- |
| Phase-A final | [`autoinit_recovery_continuation_attempt7/phase_a_result.json`](../recovery_continuation/runs/attempt7/phase_a_result.json) |
| Phase-B Stage-1 Top-5, paths, Pareto fronts | [`autoinit_phase_b_attempt5/stage1_selection.json`](../phase_b/runs/attempt5/stage1_selection.json) |
