...
- **Revisit when:** the maintainer decides what `unresolved_equivalence` means for the recipe, and whether to fix the launcher defect. Full record: [`autoinit_recovery_continuation_attempt7/`](autoinit_recovery_continuation_attempt7/).
...
- **Revisit when:** the maintainer chooses a transport. Evidence: [`autoinit_recovery_continuation_attempt2/`](autoinit_recovery_continuation_attempt2/).
...
- **Revisit when:** the maintainer decides on the `wait_endpoint` tolerance fix and a new one-use grant. Evidence: [`autoinit_recovery_continuation_attempt1/`](autoinit_recovery_continuation_attempt1/).
