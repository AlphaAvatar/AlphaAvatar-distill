...
* [`logs/current_state.json`](../logs/current_state.json) — the machine snapshot
* [`logs/STATE.md`](../logs/STATE.md) — its human view
* [`logs/BUDGET_LEDGER.md`](../logs/BUDGET_LEDGER.md) — spend and caps

Moved here from `logs/STATE.md` on 2026-08-18, unchanged, because STATE.md is a
